...
class vertex_ai_pipeline:
    def __init__(self,
                 ...
                 PROJECT_ID: str = "prj-n-mlmachine-learning-t5vl",
                 # Replace the {prod-project_id} for your prod-project-id
                 PROD_PROJECT_ID: str = "prj-p-mlmachine-learning-adlh",
                 ...
                 # Replace the prj-n-shared-restricted-ex0d with your project_id
                 DATAFLOW_SUBNET: str = "https://www.googleapis.com/compute/v1/projects/prj-n-shared-restricted-ex0d/regions/us-central1/subnetworks/sb-n-shared-restricted-us-central1",
                 JOB_NAME: str = "census-ingest",
                 # Replace the 612163840605 with your prj_n_machine_learning_number 
                 SERVICE_ACCOUNT: str = "612163840605-compute@developer.gserviceaccount.com",
                 # Replace the 556356445491 with your prj_p_machine_learning_project_number
                 PROD_SERVICE_ACCOUNT: str = "556356445491-compute@developer.gserviceaccount.com",
                 # Replace the dataflow-sa@prj-n-mlmachine-learning-t5vl.iam.gserviceaccount.com with your dataflow-sa from non-prod machine_learning_project
                 DATAFLOW_SA: str = "dataflow-sa@prj-n-mlmachine-learning-t5vl.iam.gserviceaccount.com",
                 ):
        ...
        self.SRC = SRC
        self.BUILD = BUILD
        # Replace the prj-c-mlartifacts-u80j with the name of the image in artifact project of the common folder
        self.Image = "us-central1-docker.pkg.dev/prj-c-mlartifacts-u80j/c-publish-artifacts/vertexpipeline:v2"
        ...
        self.deployment_config = {
            ...
            "encryption": 'projects/prj-p-kms-u55r/locations/us-central1/keyRings/sample-keyring/cryptoKeys/prj-p-mlmachine-learning',
...
if __name__ == "__main__":
    pipeline = vertex_ai_pipeline(
        ...
        PROJECT_ID="prj-n-mlmachine-learning-t5vl", \
        # Replace with your Machine Learning prod project ID
        PROD_PROJECT_ID='prj-p-mlmachine-learning-adlh', \
        REGION="us-central1", \
        # Replace with your bucket in non-prod ID
        BUCKET_URI="gs://bkt-n-ml-storage-bbm2euhr", \
        DATA_PATH="data", \
        ...
        DATAFLOW_SUBNET="https://www.googleapis.com/compute/v1/projects/prj-n-shared-restricted-ex0d/regions/us-central1/subnetworks/sb-n-shared-restricted-us-central1", \
        JOB_NAME="census-ingest", \
        # Replace the 612163840605 with your Non-production Machine Learning Project Number
        SERVICE_ACCOUNT="612163840605-compute@developer.gserviceaccount.com", \
        # Replace the 556356445491 with your Production Machine Learning Project Number
        PROD_SERVICE_ACCOUNT="556356445491-compute@developer.gserviceaccount.com",
        # Replace the prj-n-mlmachine-learning-t5vl with your Non-production Machine Learning Project ID
        DATAFLOW_SA="dataflow-sa@prj-n-mlmachine-learning-t5vl.iam.gserviceaccount.com",
    )
